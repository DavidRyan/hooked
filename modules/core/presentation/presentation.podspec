Pod::Spec.new do |spec|
    ...
    spec.version                  = '1.0.0'
    spec.homepage                 = 'https://hooked.app'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Core Presentation'
    spec.vendored_frameworks      = 'build/cocoapods/framework/presentation.framework'
    spec.libraries                = 'c++'
    spec.ios.deployment_target    = '14.1'
    spec.dependency 'MapboxMaps', '~> 11.18.0'
    ...
    if !Dir.exist?('build/cocoapods/framework/presentation.framework') || Dir.empty?('build/cocoapods/framework/presentation.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ...
            ./gradlew :modules:core:presentation:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':modules:core:presentation',
